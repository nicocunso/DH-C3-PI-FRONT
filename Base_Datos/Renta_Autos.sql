...
actualizado_por varchar (20) not null,
primary key (id_auto),
foreign key (id_tipo_auto) references renta_autos.tipo_autos (id_tipo_auto)
);
...
foreign key (id_cliente) references renta_autos.clientes (id_cliente),
foreign key(id_auto) references renta_autos.autos (id_auto)
);
...
foreign key (id_renta) references renta_autos.rentas (id_renta)
);
...
actualizado_por varchar (20) not null,
primary key (id_pago),
foreign key (id_factura) references renta_autos.facturas (id_factura)
);
...
foreign key (id_tipo_usuario) references renta_autos.tipo_usuarios (id_tipo_usuario)
);
