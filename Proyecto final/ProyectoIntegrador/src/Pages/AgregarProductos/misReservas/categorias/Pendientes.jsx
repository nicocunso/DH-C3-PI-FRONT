...
import pendientesStyle from './Pendientes.module.css';
...
const Pendientes = () => {
    ...
    fetch(`${baseURL}/reservas/usuarios`, options)
      ...
      .then((data) => {
        ...
        let reservasFiltradas = data.filter(reserva =>
          Date.parse(reserva.fechaInicio) < Date.parse(fechaActualFormatted)
        );
  ...
  return (
    <div className={pendientesStyle.container}>
      ...
      <div className={pendientesStyle.paginacion}>
