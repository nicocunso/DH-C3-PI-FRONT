...
const Imagenes = {
  Toyota: [toyota, Toyota1, Toyota2, Toyota3, Toyota4],
  Nissan: [nissan1, nissan2, nissan3, nissan4, nissan5],
  Honda: [civic, HCivic1, HCivic2, HCivic3, HCivic4],
  Ford: [ford, Mustang1, Mustang2, Mustang3, Mustang4],
  Chevrolet: [camaro, camaro1, camaro2, camaro3, camaro4],
  Golf: [golf1, golf, golf2, golf3, golf4],
  BMW: [bmw, bmw1, bmw2, bmw3, bmw4],
  Mercedes: [mercedes0,mercedes2, mercedes3, mercedes4, mercedes5],
  Audi: [audi1, audi2, audi3, audi4, audi5],
  Hyundai: [hyundai1, hyundai2, hyundai3, hyundai4, hyundai5],
};
